...
class MaRepairTypeController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','RepairType'),
				'users'=>array('*'),
			),
	...
	public function accessRules()
	{
		...
		else
		{
			return array(
				array('allow',  // allow all users to perform 'index' and 'view' actions
					'actions'=>array('view','delete', 'RepairType'),
					'users'=>array('*'),
				),				
				array('deny',  // deny all users
					'users'=>array('*'),
	...
	public function actionCreate()
	{
		...
		$model=new MaRepairType;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['MaRepairType']))
		{
			$model->attributes=$_POST['MaRepairType'];
			...
			if($valid)
			{
				if($model->save())
				{
					...
					$this->redirect(array('view','id'=>$model->Repairs_Type_ID));
				}
			}
			else
			{
	...
	{
		$dataProvider=new CActiveDataProvider('MaRepairType');
	...
	{
		$model=new MaRepairType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaRepairType']))
			$model->attributes=$_GET['MaRepairType'];
	...
	{
		$model=MaRepairType::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ma-repair-type-form')
		{
	...
	public function actionRepairType()
	{
		...
		if($string!='')
		{
			$model=  MaRepairType::model()->findAll(array("condition"=>"Repairs_Type like '%$string%'"));
			$data=array();
			foreach($model as $get)
			{
				$data[]=$get->Repairs_Type;
			}
			$this->layout='empty';
