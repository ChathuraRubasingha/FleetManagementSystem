...
class MaRepairsController extends Controller
{
	/**
...
*/
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MaRepairs']))
		{
			$model->attributes=$_POST['MaRepairs'];
			...
			if($valid)
			{
				if($model->save())
				{
					...
					$this->redirect(array('create','id'=>$model->Repairs_ID));
				}
			}
			else
			{
	...
	{
		$dataProvider=new CActiveDataProvider('MaRepairs');
	...
	{
		$model=new MaRepairs('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaRepairs']))
			$model->attributes=$_GET['MaRepairs'];
	...
	{
		$model=MaRepairs::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ma-repairs-form')
		{
