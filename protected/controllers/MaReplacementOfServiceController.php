...
class MaReplacementOfServiceController extends Controller
{
	/**
    ...
    public function actionAddNew()
    {
        ...
        $model = new MaReplacementOfService;
        $this->layout = 'fancy_box_layout';

        if (isset($_POST['MaReplacementOfService'])) {
            $model->attributes = $_POST['MaReplacementOfService'];
            if ($model->save())
            {                
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MaReplacementOfService']))
		{
			...
			if($valid)
			{
				...
				{
					Yii::app()->user->setFlash('success', 'Successfully Added..!');
					$this->redirect(array('view','id'=>$model->Replacement_of_Service_ID));
				}
			}
			else
			{
	...
	{
		$dataProvider=new CActiveDataProvider('MaReplacementOfService');
	...
	{
		$model=new MaReplacementOfService('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaReplacementOfService']))
			$model->attributes=$_GET['MaReplacementOfService'];
	...
	{
		$model=MaReplacementOfService::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ma-replacement-of-service-form')
		{
	...
	public function actionReplacement()
	{
		...
		if($string!='')
		{
			$model=  MaReplacementOfService::model()->findAll(array("condition"=>"Service_Replacement like '%$string%'"));
			$data=array();
			foreach($model as $get)
			{
				$data[]=$get->Service_Replacement;
			}
			$this->layout='empty';
