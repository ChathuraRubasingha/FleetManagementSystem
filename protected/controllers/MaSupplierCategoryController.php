...
class MaSupplierCategoryController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new MaSupplierCategory;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['MaSupplierCategory']))
		{
			$model->attributes=$_POST['MaSupplierCategory'];
			$valid = $model->validate();
			if($valid)
			{
			if($model->save()){
					Yii::app()->user->setFlash('success', "Successfully Added..!");
				$this->redirect(array('view','id'=>$model->Supplier_Category_ID));
			}
			}
			else
			{
	...
	{
		$dataProvider=new CActiveDataProvider('MaSupplierCategory');
	...
	{
		$model=new MaSupplierCategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaSupplierCategory']))
			$model->attributes=$_GET['MaSupplierCategory'];
	...
	{
		$model=MaSupplierCategory::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ma-supplier-category-form')
		{
