...
class MaUserController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('MaUser');
	...
	{
		$model=new MaUser('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaUser']))
			$model->attributes=$_GET['MaUser'];
	...
	{
		$model=MaUser::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ma-user-form')
		{
