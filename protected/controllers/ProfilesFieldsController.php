...
class ProfilesFieldsController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ProfilesFields'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['ProfilesFields']))
			$model->attributes=$_GET['ProfilesFields'];
	...
	{
		$model=ProfilesFields::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='profiles-fields-form')
		{
