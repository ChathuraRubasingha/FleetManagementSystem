...
class AccessControlActions extends CActiveRecord
{
	...
	/*	$cmd = "Select access_control_actions.Action_Display_Name,
    			...
    			access_controllers.ID
				Where access_controllers.ID = '".$id."'  and access_control_actions.Action_Display_Name <>''";
		$array = Yii::app()->db->createCommand($cmd)->queryAll();
		
		
		$cmd="select action_id from access_user_roll where Contoller_ID = '".$id."' And Role_ID = '".$rol."'";	
 ...
 */
				...
				Where access_controllers.ID = '".$id."' 
                                and access_control_actions.Action_Display_Name != 'null'";	
