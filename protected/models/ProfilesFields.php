...
class ProfilesFields extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('varname, title, field_type, createtime', 'required'),
			...
			array('id, varname, title, field_type, field_size, field_size_min, required, match, range, error_message, other_validator, default, widget, widgetparams, position, visible, createtime', 'safe', 'on'=>'search'),
		);
	}
