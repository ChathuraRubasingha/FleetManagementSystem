...
class emissionTestForm extends CFormModel
{
    ...
    public function rprint($valFrom,$valTo)
	{
		...
		//--Get data array 
		$mystr=$DataSource->ArrayEmissionTest($valFrom,$valTo);		
		...
		$pdf->ezText(Yii::app()->params['companyName'],14);
		 ...
		 $pdf->ezText('',5);
		 $pdf->ezText('Emission Test Due Report',10);
		 $pdf->ezText('',5);
		...
		{
		 $pdf->ezTable($mystr,array('Vehicle_No'=>'Vehicle No.','Category_Name'=>'Category', 'Company_Name'=>'Tested by','Amount'=>'Amount','Valid_From'=>'Valid From','Valid_To'=>'Valid To'),'',
		 array('cols' => array('Vehicle_No' => array('width'=>'90'), 'Category_Name' => array('width'=>'90'), 'Company_Name' => array('width'=>'100'), 'Amount' => array('justification' => 'right', 'width'=>'90'), 'Valid_From' => array('width'=>'90'), 'Valid_To' => array('width'=>'90'))));
			}
		else
		{
