...
INSERT INTO tbl_users (id, username, password, email, activkey, createtime, lastvisit, superuser, status) VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'webmaster@example.com', '21232f297a57a5a743894a0e4a801fc3', 1261146094, 0, 1, 1,0,1);
INSERT INTO tbl_users (id, username, password, email, activkey, createtime, lastvisit, superuser, status) VALUES (2, 'demo', 'fe01ce2a7fbac8fafaed7c982a04e229', 'demo@example.com', 'fe01ce2a7fbac8fafaed7c982a04e229', 1261146096, 0, 0, 1,0,1);

ALTER TABLE `tbl_users`
  ADD CONSTRAINT `ma_user_ibfk_2` FOREIGN KEY (`Designation_ID`) REFERENCES `ma_designation` (`Designation_ID`),
  ADD CONSTRAINT `ma_user_ibfk_3` FOREIGN KEY (`Role_ID`) REFERENCES `ma_role` (`Role_ID`);
...
INSERT INTO tbl_profiles_fields (id, varname, title, field_type, field_size, field_size_min, required, 'match', range, error_message, other_validator, 'default', widget, widgetparams, position, visible) VALUES (3, 'birthday', 'Birth Day', 'DATE', 0, 0, 2, '', '', '', '', '0000-00-00', 'UWjuidate', '{"ui-theme":"redmond"}', 3, 2);
