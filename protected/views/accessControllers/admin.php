...
<li style="display:none"><?php echo CHtml::link('Update Controllers',array('/accessControllers/create')); ?></li>
<li style="display:none"><?php echo CHtml::link('Manage Controllers',array('/accessControllers/admin')); ?></li>
<li style="display:none"><?php echo CHtml::link('Update Actions',array('/accessControlActions/admin')); ?></li>
...
<h1>Access Controller Registry</h1>
...
<div style="margin-left:93%; margin-top:-3.5%; margin-bottom:-2%">
