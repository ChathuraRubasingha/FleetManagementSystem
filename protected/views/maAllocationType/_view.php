<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->Allocation_Type_ID), array('view', 'id'=>$data->Allocation_Type_ID)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Allocation_Type')); ?>:</b>
	<?php echo CHtml::encode($data->Allocation_Type); ?>
	<br />
