                ...
                <ul class="breadcrumb">
                    ...
                    if($userRole !=='3')
                    {
                        $this->breadcrumbs=array(
                            ...
                            'Designation'=>array('/maDesignation/admin'),
                            'Designation Details',
                        );
                    }
                    ?>
            ...
            <div class="col-xs-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Designation Details</h1>
...
<?php echo CHtml::link('<img src="images/add.png" class="addIcon"  />',array('maDesignation/create',"menuId"=>"configuration"), array('title'=>'Add'));?>
                            <?php echo CHtml::link('<img src="images/manage.png" class="manageIcon" />',array('maDesignation/admin',"menuId"=>"configuration"),array('title'=>'Manage')); ?>
                            <?php echo CHtml::link('<img src="images/update.png" class="updateIcon" />',array('maDesignation/update&id='.$id,"menuId"=>"configuration"),array('title'=>'Update')); ?>
                        </div>
                    </div>
