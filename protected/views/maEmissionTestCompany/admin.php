...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-emission-test-company-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Emission Test Company Registry</h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'ma-emission-test-company-grid',
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maEmissionTestCompany/update", array("id" =>
                                        $data["Emission_Test_Company_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maEmissionTestCompany/view", array("id" =>
                                        $data["Emission_Test_Company_ID"], "menuId"=>"configuration"))',
