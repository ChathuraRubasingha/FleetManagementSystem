...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-garages-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Garage Registry</h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns'=>array(
                                'Garage_Name',
                                array('name'=>'Garage_Type', 'header'=>'Garage Type', 'value'=>'$data->garageType->Garage_Type'),
                                ...
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maGarages/update", array("id" =>
                                        $data["Garage_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maGarages/view", array("id" =>
                                        $data["Garage_ID"], "menuId"=>"configuration"))',
