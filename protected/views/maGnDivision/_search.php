...
<div class="formTable">
        ...
        <div class="tblrow">
            	<div class="tdOne"><?php echo $form->label($model,'DS_Division_ID'); ?></div>
		<div class="tdTwo"><?php  $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
                                'model'=>$model,
                                'name'=>'DS_Division_ID',
                                'attribute'=>'DS_Division_ID',
	...
	<div class="tblrow">
            	<div class="tdOne"><?php echo $form->label($model,'GN_Division'); ?></div>
		<div class="tdTwo"><?php  $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
                                'model'=>$model,
                                'name'=>'GN_Division',
                                'attribute'=>'GN_Division',
                                // additional javascript options for the autocomplete plugin
                                'options'=>array(
                                    'minLength'=>'0',
                                    
                                ),
                                'source'=>$this->createUrl("MaGnDivision/gnDivisions"),
                                'htmlOptions'=>array('class'=>'midText',
                                    'data-value'=>'',
