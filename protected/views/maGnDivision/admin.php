...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-gn-division-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">GN Division Registry</h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'ma-gn-division-grid',
                            'dataProvider'=>$model->search(),
                            //'filter'=>$model,
                            'columns'=>array(
                                array('name'=>'DS_Division', 'header'=>'DS Division', 'value'=>'$data->dSDivision->DS_Division'),
                                'GN_Division',
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maGnDivision/update", array("id" =>
                                        $data["GN_Division_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maGnDivision/view", array("id" =>
                                        $data["GN_Division_ID"], "menuId"=>"configuration"))',
