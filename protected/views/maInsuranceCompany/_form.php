...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="formTable" >
        ...
        <div class="tblRow">
            <div class="tdOne"><?php echo $form->labelEx($model,'Insurance_Company_Name'); ?></div>
            <div class="tdTwo"><?php echo $form->textField($model,'Insurance_Company_Name',array('maxlength'=>255)); ?>
                <?php echo $form->error($model,'Insurance_Company_Name'); ?></div>
        </div>
	
        <div class="tblRow">
            <div class="tdOne"><?php echo $form->labelEx($model,'Contact_Person'); ?></div>
            <div class="tdTwo"><?php echo $form->textField($model,'Contact_Person',array('maxlength'=>100)); ?>
                <?php echo $form->error($model,'Contact_Person'); ?></div>
        </div>
        
        <div class="tblRow">
            <div class="tdOne"><?php echo $form->labelEx($model,'Email'); ?></div>
            <div class="tdTwo"><?php echo $form->textField($model,'Email',array('maxlength'=>100)); ?>
