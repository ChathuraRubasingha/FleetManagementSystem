...
<div class="formTable">
        ...
        <div class="tblrow">
            	<div class="tdOne"><?php echo $form->label($model,'Insurance_Company_Name'); ?></div>
		<div class="tdTwo"><?php  $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
                                'model'=>$model,
                                'name'=>'Insurance_Company_Name',
                                'attribute'=>'Insurance_Company_Name',
                                // additional javascript options for the autocomplete plugin
                                'options'=>array(
                                    'minLength'=>'0',
                                    
                                ),
                                'source'=>$this->createUrl("MaInsuranceCompany/InsuranceCompany"),
