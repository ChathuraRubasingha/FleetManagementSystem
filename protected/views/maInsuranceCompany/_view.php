<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->Insurance_Company_ID), array('view', 'id'=>$data->Insurance_Company_ID)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Insurance_Company_Name')); ?>:</b>
	<?php echo CHtml::encode($data->Insurance_Company_Name); ?>
	<br />
