...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="tblRow">
        <div class="tdOne"><?php echo $form->labelEx($model,'Insurance_Type'); ?></div>
        <div class="tdTwo"><?php echo $form->textField($model,'Insurance_Type',array('class'=>'midText','maxlength'=>200)); ?>
		<?php echo $form->error($model,'Insurance_Type'); ?></div>
    </div>
