...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-location-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Location Registry</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maLocation/update", array("id" =>
                                        $data["Location_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maLocation/view", array("id" =>
                                        $data["Location_ID"], "menuId"=>"configuration"))',
