            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Add Provincial Council</h1>
...
<?php echo CHtml::link('<img src="images/manage.png" class="manageIcon" />',array('maProvincialCouncils/admin',"menuId"=>"configuration"),array('title'=>'Manage')); ?>
                        ...
                        #echo CHtml::link('<img src="images/add.png" style="height:50px; width:50px; margin-right:4px !important"  />',array('maProvincialCouncils/create'),array('title'=>'Add'));
                      //  echo CHtml::link('<img src="images/manage.png" style="height:40px; width:30px; margin-right:15px !important"  />',array('maProvincialCouncils/admin'),array('title'=>'Manage'));
