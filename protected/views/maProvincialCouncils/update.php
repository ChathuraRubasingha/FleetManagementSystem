                ...
                <ul class="breadcrumb">
                    ...
                    if($userRole !=='3')
                    {
                        ...
                        $this->breadcrumbs=array(
                            ...
                            'Update Provincial Council Details',
                        );
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Update Provincial Council Details</h1>
...
<?php echo CHtml::link('<img src="images/add.png" class="addIcon"  />',array('maProvincialCouncils/create',"menuId"=>"configuration"), array('title'=>'Add'));?>
                            <?php echo CHtml::link('<img src="images/manage.png" class="manageIcon" />',array('maProvincialCouncils/admin'),array('title'=>'Manage')); ?>
                        </div>
                    </div>
