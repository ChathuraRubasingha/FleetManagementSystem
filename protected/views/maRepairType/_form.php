...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
    <tr><td>
		<?php echo $form->labelEx($model,'Repairs_Type'); ?>
        </td><td>
		<?php echo $form->textField($model,'Repairs_Type',array('size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'Repairs_Type'); ?>
        </td></tr>
	</div>
