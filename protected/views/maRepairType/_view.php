<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->Repairs_Type_ID), array('view', 'id'=>$data->Repairs_Type_ID)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Repairs_Type')); ?>:</b>
	<?php echo CHtml::encode($data->Repairs_Type); ?>
	<br />
