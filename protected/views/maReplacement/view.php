            ...
            <div class="col-xs-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Replacement Details</h1>
...
<?php echo CHtml::link('<img src="images/add.png" class="addIcon"  />',array('maReplacement/create',"menuId"=>"configuration"), array('title'=>'Add'));?>
                            ...
                            <?php echo CHtml::link('<img src="images/update.png" class="updateIcon" />',array('maReplacement/update&id='.$id,"menuId"=>"configuration"),array('title'=>'Update')); ?>
                        </div>
                    </div>
