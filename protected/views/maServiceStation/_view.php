<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->Service_Station_ID), array('view', 'id'=>$data->Service_Station_ID)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Srvice_Station_Name')); ?>:</b>
	<?php echo CHtml::encode($data->Srvice_Station_Name); ?>
	<br />
