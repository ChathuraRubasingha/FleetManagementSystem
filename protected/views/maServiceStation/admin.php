...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-service-station-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Service Station Registry</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maServiceStation/update", array("id" =>
                                        $data["Service_Station_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maServiceStation/view", array("id" =>
                                        $data["Service_Station_ID"], "menuId"=>"configuration"))',
