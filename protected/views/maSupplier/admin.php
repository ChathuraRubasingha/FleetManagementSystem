...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('ma-supplier-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Supplier Registry</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/maSupplier/update", array("id" =>
                                        $data["Supplier_ID"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/maSupplier/view", array("id" =>
                                        $data["Supplier_ID"], "menuId"=>"configuration"))',
