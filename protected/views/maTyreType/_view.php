<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->Tyre_Type_ID), array('view', 'id'=>$data->Tyre_Type_ID)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Tyre_Type')); ?>:</b>
	<?php echo CHtml::encode($data->Tyre_Type); ?>
	<br />
