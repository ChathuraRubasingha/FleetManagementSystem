...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('odometer-update-remark-grid', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Odometer Update Remarks Registry</h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'odometer-update-remark-grid',
                            'dataProvider'=>$model->search(),
                            'columns'=>array(
                                'description',
                                array(
                                    'class'=>'CButtonColumn',
                                    'updateButtonUrl'=>'Yii::app()->createUrl("/odometerUpdateRemark/update", array("id" =>
                                        $data["remark_id"], "menuId"=>"configuration"))',
                                    'viewButtonUrl'=>'Yii::app()->createUrl("/odometerUpdateRemark/view", array("id" =>
                                        $data["remark_id"], "menuId"=>"configuration"))',
