        ...
        <div class="panel panel-default rating-widget">
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Fuel Consumption Report - Vehicle wise</h1>
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    ...
                                    'buttons'=>array('view'=>array(
                                        ...
                                        'url'=>'Yii::app()->createUrl("/report/FuelConsumptionByVehecleDate",  array("ReportGridMemberID" =>$data["Vehicle_No"],"menuId"=>"reports","linkid"=>"FuelConsumptionByVehicle"))',))
                                ),
                                /*array(
                                    'class'=>'CButtonColumn',
                                    'template'=>'{view}',
                                    ...
                                    (
                                        ...
                                        (
                                            ...
                                            'url'=>'Yii::app()->createUrl("/report/FuelConsumptionByVehecleDate", array("ReportGridMemberID" =>$data["Vehicle_No"]))',
                                        ),
                                    ),
