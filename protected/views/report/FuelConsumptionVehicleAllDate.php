...
<script>
    ...
    {
        $('#FuelConsumptionAllVehicleDateForm_Valid_From').Zebra_DatePicker();
        $('#FuelConsumptionAllVehicleDateForm_Valid_To').Zebra_DatePicker();
    });
</script>
...
<div class="container body">
    ...
    <div class="col-xs-4" style="width:60%;height:50%;float:left">
        <div class="panel panel-default rating-widget">
            <div class="panel-heading large">
                <h4 class="panel-title">Fuel Consumption Report</h4>
            </div>
            <div class="panel-body"  style="height:auto">
               <?php $form=$this->beginWidget('CActiveForm', array(
                    'id'=>'fuelCousumption-form',
