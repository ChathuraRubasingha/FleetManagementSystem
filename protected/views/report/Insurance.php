...
$this->breadcrumbs=array(
    ...
    'Insurance Schedule Report-(Vehicle Wise) '
);
?>
<script>
    $(document).ready(function()
    {
        $('#InsuranceForm_Valid_From').Zebra_DatePicker();
        $('#InsuranceForm_Valid_To').Zebra_DatePicker();
    });
...
<div class="col-xs-4" style="width:60%;height:50%;float:left">
    <div class="panel panel-default rating-widget">
        <div class="panel-heading large">
            <h4 class="panel-title">Insurance Schedule Report-(Vehicle Wise)</h4>
        </div>
        <div class="panel-body"  style="height:auto">
           <?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    ?>
                            ...
                            <div class="tblrow">
                                        <div class="tdOne"><?php  echo $form->labelEx($mode1ns,'Vehicle_Category_ID'); ?></div>
                                        <div class="tdTwo"><?php echo $form->dropDownList($mode1ns, 'Vehicle_Category_ID', CHtml::listData(
                                        VehicleCategory::model()->findAllCategories(), 'Vehicle_Category_ID', 'Category_Name'),array('prompt' => '--- Please Select ---', 'class'=>'midSelect'))
                                    ;   ?><?php echo $form->error($mode1ns,'Vehicle_Category_ID'); ?></div>
                                    </div>
