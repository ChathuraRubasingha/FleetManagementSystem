...
$this->breadcrumbs=array(
    ...
    'Emission Test Due Date Report'
);
?>
<script>
    $(document).ready(function()
    {
        $('#emissionTestForm_Valid_From').Zebra_DatePicker();
        $('#emissionTestForm_Valid_To').Zebra_DatePicker();
    });
</script>
...
<div class="container body">
    ...
    <div class="col-xs-4" style="width:60%;height:50%;float:left">
        <div class="panel panel-default rating-widget">
            <div class="panel-heading large">
                <h4 class="panel-title"> Emission Test Due Date Report</h4>
            </div>
