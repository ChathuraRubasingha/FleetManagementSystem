...
<div class="container body">
    ...
    <div class="col-xs-4" style="width:60%;height:50%;float:left">
        <div class="panel panel-default rating-widget">
            <div class="panel-heading large">
                <h4 class="panel-title">Vehicle Details Report - Category wise</h4>
            </div>
               ...
               <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <div class="formTable">
                    ...
                    <div class="tblrow">
                        ...
                        <div class="tdTwo"><?php echo $form->dropdownlist($model,'Vehicle_Category_ID',CHtml::listData(VehicleCategory::model()->getVehicleCatForCategoryReport(),'Vehicle_Category_ID','Category_Name'),array('prompt' => '--- Please Select ---','class'=>'midSelect'));  ?>
