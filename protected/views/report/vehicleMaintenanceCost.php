        ...
        <div class="panel panel-default rating-widget">
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Maintenance Cost Reports</h1>
                            ...
                            'columns'=>array(
                                ...
                                array(
                                    ...
                                    'buttons'=>array('view'=>array(
                                        ...
                                        'url'=>'Yii::app()->createUrl("/report/vehicleMaintenanceCostDate",  array("ReportGridMemberID" =>$data["Vehicle_No"],"menuId"=>"reports","linkid"=>"vehicleMaintenanceCost"))',))
                                ),
