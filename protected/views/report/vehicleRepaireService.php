...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('Vehicle-repair-search-details-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <div class="panel panel-default rating-widget">
            ...
            <div class="col-xs-8">
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Repair/Service Report</h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">Select Vehicle from the below list.
                        ...
                        <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'Vehicle-repair-search-details-grid',
                            ...
                            'columns'=>array(
                                ...
                                array('name'=>'Location_ID', 'header'=>'Location', 'value'=>'$data->fuelType->Fuel_Type'),
                                ...
                                array(
                                    ...
                                    'buttons'=>array('view'=>array(
                                        ...
                                        'url'=>'Yii::app()->createUrl("/report/vehicleRepaireServiceDate", array("ReportGridMemberID" =>
                                        $data["Vehicle_No"], "menuId"=>"reports"))'))
                                ),
                                ...
                                /*array(
                                    ...
                                    (
                                        'view' => array
                                        (
                                            'url'=>'Yii::app()->createUrl("/report/vehicleRepaireServiceDate",  array("ReportGridMemberID" =>$data["Vehicle_No"]))',
                                        ),
                                    ),
