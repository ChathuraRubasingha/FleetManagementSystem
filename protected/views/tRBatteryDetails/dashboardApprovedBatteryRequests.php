        ...
        <div class="row rest-view" itemscope itemtype="http://schema.org/Restaurant">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading large" style="color:#fff; background: #65a6ff">
                        <h1 class="panel-title" itemprop="name">Approved Battery Requests </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12">
             ...
             <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'dataProvider'=>$model->getPendingBatteryReplacementsDashBoard(),
                'columns'=>array(
                    'Battery_Details_ID',
                    'Vehicle_No',
                    ...
                    /*array(
                        ...
                        $data["Battery_Details_ID"],"vid" => $data["Vehicle_No"]))',
