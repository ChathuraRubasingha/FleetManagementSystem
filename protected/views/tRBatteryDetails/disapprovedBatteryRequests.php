...
if($userRole !=='3')
{
    $title="Disapproved Battery Requests Registry";
    $disapproved="Disapproved By";
    $disAppDate ="Disapproved Date";
}
else
{
	$title='අනුමත නොකළ බැටරි අයදුම්';
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider'=>$model->getDisapprovedBatteryRequests(),
                                #'filter'=>$model,
                                'columns'=>array(
                                    'Battery_Details_ID',
                                    ...
                                    array(
                                        'class'=>'CButtonColumn',
                                        'template'=>'{view}',
                                        'viewButtonUrl'=>'Yii::app()->createUrl("/tRBatteryDetails/view", array("id"=>$data["Battery_Details_ID"], "type"=>"disapproved"))'
                                    ),
                                ),
                            )); ?>
                        </div>
