...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Emission_test_ID'); ?>
		<?php echo $form->textField($model,'Emission_test_ID'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'Emission_Test_Company_ID'); ?>
		<?php echo $form->textField($model,'Emission_Test_Company_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'Emission_Test_Date'); ?>
		<?php echo $form->textField($model,'Emission_Test_Date'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'Emission_Test_Result'); ?>
		<?php echo $form->textField($model,'Emission_Test_Result',array('size'=>50,'maxlength'=>50)); ?>
	</div>
