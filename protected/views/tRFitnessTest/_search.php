...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Fitness_Test_ID'); ?>
		<?php echo $form->textField($model,'Fitness_Test_ID'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'Fitness_Test_Result'); ?>
		<?php echo $form->textField($model,'Fitness_Test_Result',array('size'=>60,'maxlength'=>100)); ?>
	</div>
