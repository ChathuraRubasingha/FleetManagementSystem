<?php 
    ...
    if($userRole !=='3')
    {
        ...
        $('.search-form form').submit(function(){
            $.fn.yiiGridView.update('approved-fuel-grid', {
                data: $(this).serialize()
            });
            return false;
        });
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php $this->widget('zii.widgets.grid.CGridView', array(
                                    'id'=>'approved-fuel-grid',
                                    'dataProvider'=>$model->getApprovedFuelRequests($vehicleId),
                                    'columns'=>array(
                                        'Request_Date',
                                        ...
                                        array(
                                            'class'=>'CButtonColumn',
                                            'template'=>'{view}',
                                            'viewButtonUrl'=>'Yii::app()->createUrl("/tRFuelRequestDetails/view", array("id"=>$data["Fuel_Request_ID"],"type"=>"approved", "menuId"=>"fuel"))',
