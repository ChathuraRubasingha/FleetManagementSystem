<?php 
    ...
    if($userRole !=='3')
    {
        $title ="Disapproved Fuel Requests";
        ...
        $('.search-form form').submit(function(){
            $.fn.yiiGridView.update('disapproved-fuel-grid', {
                data: $(this).serialize()
            });
            return false;
        });
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php $this->widget('zii.widgets.grid.CGridView', array(
                                    'id'=>'disapproved-fuel-grid',
                                    'dataProvider'=>$model->getDisapprovedFuelRequests(),
                                    'columns'=>array(
                                        'Request_Date',
                                        ...
                                        array(
                                            'class'=>'CButtonColumn',
                                            'template'=>'{view}',
                                            'viewButtonUrl'=>'Yii::app()->createUrl("/tRFuelRequestDetails/view", array("id"=>$data["Fuel_Request_ID"],"type"=>"disapproved", "menuId"=>"fuel"))',
                                        ),
                                    ),
                                )); ?>
                            </div>
