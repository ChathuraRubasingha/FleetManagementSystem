...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Date_of_License'); ?>
		<?php echo $form->textField($model,'Date_of_License'); ?>
	</div>
	...
	<div class="row" style="display:none">
		<?php echo $form->label($model,'Fitness_ID'); ?>
		<?php echo $form->textField($model,'Fitness_ID'); ?>
	</div>
