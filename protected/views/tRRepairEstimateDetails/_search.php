...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Total_Estimate'); ?>
		<?php echo $form->textField($model,'Total_Estimate',array('size'=>60,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'Estimate_Date'); ?>
		<?php echo $form->textField($model,'Estimate_Date'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'Estimate_Status'); ?>
		<?php echo $form->textField($model,'Estimate_Status',array('size'=>12,'maxlength'=>12)); ?>
	</div>
