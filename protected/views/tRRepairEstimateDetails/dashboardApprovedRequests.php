...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('#saveReject').click(function()
        {
            ...
            var EstimateID = $('#txtReqestID').val();
            ...
            if(reason !== '')
            {
                ...
                ({
                    ...
                    data : {'EstimateID':EstimateID, "reason":reason},
        ...
        <div class="row rest-view" itemscope itemtype="http://schema.org/Restaurant">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading large" style="color:#fff; background: #57517b">
                        <h1 class="panel-title" itemprop="name">Approved Repair Requests</h1>
                    </div>
                </div>
            </div>
            ...
            <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'dataProvider'=>$model->getApprovedEstimatesDashBoard(),
                'columns'=>array(
                    'Estimate_ID',
                    'Request_ID',
                    'Vehicle_No',
