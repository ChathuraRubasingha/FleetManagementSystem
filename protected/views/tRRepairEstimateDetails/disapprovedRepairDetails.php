...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('disapproved-repair-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if($userRole !=='3')
{
    $title="Disapproved Repair Requests Registry";
}
else
{
	$title='අනුමත නොකළ අලුත්වැඩියා අයදුම්';
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $this->widget('zii.widgets.grid.CGridView', array(
                                'id'=>'disapproved-repair-grid',
                                'dataProvider'=>$model->getDisapprovedRepairRequests(),
                                #'filter'=>$model,
                                'columns'=>array(
                                    'Request_ID',
                                    ...
                                    array(
                                        'class'=>'CButtonColumn',
                                        'template'=>'{view}',
                                        'viewButtonUrl'=>'Yii::app()->createUrl("/tRRepairEstimateDetails/view", array("id"=>$data->Estimate_ID, "type"=>"Disapproved"))'
                                    ),
                                ),
                            )); ?>
                        </div>
