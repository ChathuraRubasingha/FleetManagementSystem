...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Service_Station_ID'); ?>
		<?php echo $form->textField($model,'Service_Station_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'Service_Type_ID'); ?>
		<?php echo $form->textField($model,'Service_Type_ID'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Meter_Reading',array('size'=>50,'maxlength'=>50)); ?>
	</div>

	<div class="row" style="display:none">
		<?php echo $form->label($model,'Driving_Distance'); ?>
		<?php echo $form->textField($model,'Driving_Distance',array('size'=>50,'maxlength'=>50)); ?>
	</div>
	...
	<div class="row" style="display:none">
		<?php echo $form->label($model,'Estimate_Cost'); ?>
		<?php echo $form->textField($model,'Estimate_Cost',array('size'=>60,'maxlength'=>100)); ?>
	</div>
