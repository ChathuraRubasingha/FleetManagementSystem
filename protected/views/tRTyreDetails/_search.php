...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Tyre_Details_ID'); ?>
		<?php echo $form->textField($model,'Tyre_Details_ID'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'Replace_Status'); ?>
		<?php echo $form->textField($model,'Replace_Status',array('size'=>10,'maxlength'=>10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'Replace_Date'); ?>
		<?php echo $form->textField($model,'Replace_Date'); ?>
	</div>
