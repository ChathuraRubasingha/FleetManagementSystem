<?php
    ...
    if($userRole !=='3')
    {
        ...
        $title="Disapproved Tyre Requests Registry";
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $this->widget('zii.widgets.grid.CGridView', array(
                                'id'=>'disapproved-Tyre-grid',
                                'dataProvider'=>$model->getDisapprovedTyreRequests(),
                                'columns'=>array(
                                    'Tyre_Details_ID',
                                    'Request_Date',
                                    ...
                                    array('header'=>$disapproved, 'value'=>'$data->Approved_By'),
                                    array('header'=>$disAppDate, 'value'=>'$data->Approved_Date'),

                                    array(
                                        'class'=>'CButtonColumn',
                                        'template'=>'{view}',
                                        'viewButtonUrl'=>'Yii::app()->createUrl("/tRTyreDetails/view", array("id"=>$data["Tyre_Details_ID"], "type"=>"disapproved"))'
                                    ),
                                ),
                            )); ?>
