...
if($userRole !=='3')
{
    $title="Tyre Replacement History of the Vehicle";
}
else
{
	$title="වාහනයේ පෙර කරන ලද ටයර මාරු කිරීම් පිලිබඳ තොරතුරු";
}
?>
...
<?php echo CHtml::link('<img src="images/add.png" class="addIcon"  />',array('tRTyreDetails/create'), array('title'=>'Add'));?>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider'=>$model->getTyreReplacementHistory(),
                                'columns'=>array(
                                    'Tyre_Details_ID',
