...
$curDateTime = MaVehicleRegistry::model()->getServerDate("dateTime");
	...
	$branch_id = $model->Branch_Id==null?"":$model->Branch_Id;
...
<script>
   ...
   var location_id = $("#TRVehicleLocation_Location_ID").val();
   var branch_id = '<?php echo $branch_id?>';
	
   $.ajax({

                 type:'POST',
                 url :'<?php echo Yii::app()->createAbsoluteUrl("TRVehicleLocation/GetBranch")?>',
                 ...
                 {      
                        ...
                        $("#TRVehicleLocation_Branch_Id").empty().append(response);
	...
	?>
        ...
        <div class="tblRow">
            ...
            <div class="tdTwo"><?php  echo $form->dropDownList($model,'Location_ID',CHtml::listData(MaLocation::model()->findAllLocations(),'Location_ID','Location_Name'),array('prompt'=>'--- Please Select ---','class'=>'largeSelect','onChange'=>'setBranch();')); ?>
        ...
        <div class="tblRow">
            <div class="tdOne"><?php echo $form->labelEx($model,'Branch_Id'); ?></div>
            <div class="tdTwo"><?php //echo $form->textfield($model,'branch');?>
            <?php  echo $form->dropDownList($model,'Branch_Id',array(),array('prompt'=>'--- Please Select ---','class'=>'largeSelect')); ?>
            </div>
