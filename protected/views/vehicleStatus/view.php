                ...
                <ul class="breadcrumb">
                    ...
                    if($userRole !=='3')
                    {
                        $this->breadcrumbs=array(
                            ...
                            'Vehicle Status'=>array('/vehicleStatus/admin'),
            ...
            <div class="col-xs-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading large">
                        <h1 id="rest-title" class="panel-title" itemprop="name">Vehicle Status Details</h1>
...
<?php echo CHtml::link('<img src="images/add.png" class="addIcon"  />',array('vehicleStatus/create',"menuId"=>"configuration"), array('title'=>'Add'));?>
    <?php echo CHtml::link('<img src="images/manage.png" class="manageIcon" />',array('vehicleStatus/admin',"menuId"=>"configuration"),array('title'=>'Manage')); ?>
                            <?php echo CHtml::link('<img src="images/update.png" class="updateIcon" />',array('vehicleStatus/update&id='.$id,"menuId"=>"configuration"),array('title'=>'Update')); ?>
                        </div>
                    </div>
