...
$this->breadcrumbs=array(
	...
	'Assigned Location History'=>array('/tRVehicleLocation/locationAssignedVehicels'),
	'Assigned Location History of the Vehicle'
);
...
<!--<div class="add">
 <?php  #echo  CHtml::link('<img src="images/assign.png" style="height:58px; width="58px""  />',array('tRVehicleLocation/Create&vNo='.$vNo));?> 
</div>-->
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array('name'=>'Location_ID', 'header'=>'Location', 'value'=>'$data->toLocation->Location_Name'),
		'From_Date',
		'To_Date',
